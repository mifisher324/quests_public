...
function event_say(e)
  ...
  elseif e.other:IsTaskActivityActive(bic_qinimi, 11) or e.other:IsTaskActivityActive(bic_qinimi, 12) or e.other:GetGM() then
      ...
      e.other:UpdateTaskActivity(bic_qinimi, 11, 1)
    end
  ...
  elseif e.other:IsTaskActivityActive(bic_qinimi, 6) then
	...
	elseif e.other:IsTaskActivityActive(bic_qinimi, 4) then
...
function event_trade(e)
    ...
    e.other:UpdateTaskActivity(bic_qinimi, 2, 1)
  elseif item_lib.check_turn_in(e.trade, {item1 = 67398}) then --Stonedust Particles
    e.other:UpdateTaskActivity(bic_qinimi, 5, 1)
    if not e.other:IsTaskActivityActive(bic_qinimi, 3) and not e.other:IsTaskActivityActive(bic_qinimi, 4) and not e.other:IsTaskActivityActive(bic_qinimi, 5) then
      give_stone(e)
    end
  elseif item_lib.check_turn_in(e.trade, {item1 = 67399}) then --Glob of Mud
    e.other:UpdateTaskActivity(bic_qinimi, 4, 1)
    if not e.other:IsTaskActivityActive(bic_qinimi, 3) and not e.other:IsTaskActivityActive(bic_qinimi, 4) and not e.other:IsTaskActivityActive(bic_qinimi, 5) then
      give_stone(e)
    end
	elseif item_lib.check_turn_in(e.trade, {item1 = 67400}) then -- Piece of Chalk
    e.other:UpdateTaskActivity(bic_qinimi, 3, 1)
    if not e.other:IsTaskActivityActive(bic_qinimi, 3) and not e.other:IsTaskActivityActive(bic_qinimi, 4) and not e.other:IsTaskActivityActive(bic_qinimi, 5) then
      give_stone(e)
    end
    ...
    e.other:UpdateTaskActivity(bic_qinimi, 10, 1)
	end
