function event_say(e)
  ...
  if aby_bic == 0 then
    ...
    if e.message:findi('yxtta') then
      ...
      e.other:SetBucket("god.bic.yxtta", "1")
    end
    if e.message:findi('frightful temple') then
      ...
      e.other:SetBucket("god.bic.kodtaz", "1")
    end
  end
end
...
function event_trade(e)
  ...
  if item_lib.check_turn_in(e.trade, {item1 = 67562}) then
    if kod_bic == 3 then
      ...
      e.other:SetBucket("god.bic.kodtaz", "4")
      e.other:SummonItem(67569)
    else
      item_lib.return_items(e.self, e.other, e.trade)
    end
  end

  if item_lib.check_turn_in(e.trade, {item1 = 67561}) then
    if kod_bic == 1 then
  ...
  if item_lib.check_turn_in(e.trade, {item1 = 67556, item2 = 67703, item3 = 67557, item4 = 67558}) then
    if yxt_bic == 2 then
      ...
      e.other:SummonItem(67570)
      e.other:SetBucket("god.bic.yxtta", "3")
    else
      item_lib.return_items(e.self, e.other, e.trade)
    end
  end
