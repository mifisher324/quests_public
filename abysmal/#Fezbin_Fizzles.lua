...
function event_say(e)
  ...
  elseif e.other:IsTaskActive(bic_abysmal) then
    ...
    if e.message:findi('completed') then
      if e.other:IsTaskCompleted(bic_qinimi) and e.other:IsTaskCompleted(bic_barindu) and e.other:IsTaskCompleted(bic_riwwi) and e.other:IsTaskCompleted(bic_ferubi) and e.other:IsTaskCompleted(bic_sewers) and e.other:IsTaskCompleted(bic_vxed) and e.other:IsTaskCompleted(bic_tipt) and e.other:IsTaskCompleted(bic_outer) and e.other:IsTaskCompleted(bic_yxtta) and other e.other:IsTaskCompleted(bic_kodtaz) then
    ...
    if e.mssage:findi('discovered') then
