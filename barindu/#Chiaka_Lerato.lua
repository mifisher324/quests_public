...
function event_trade(e)
    ...
    e.other:UpdateTaskActivity(bic_barindu, 10, 1)
  end
  if item_lib.check_turn_in(e.trade, {item1 = 64008}) then --tattered shawl
    ...
    eq.start(56);
    e.other:UpdateTaskActivity(bic_barindu, 12, 1)
	end
