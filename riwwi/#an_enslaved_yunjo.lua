...
function event_signal(e)
  if e.signal == 1 then
    e.Say(MT.NPCQuestSay, "Stand fast and prepare for a fight! They're sending a bloodthirsty beast into the arena to kill you as we speak. If you defeat it, place the head in this sack as proof and return it to Turlini. He is the leader of the resistance and may be able to assist you for helping us.")
  end
end
