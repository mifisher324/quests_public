function event_say(e)
  ...
  if rep > 2 then
    ...
    if riw_bic >= 2 then
      ...
      e.other:Message(MT.NPCQuestSay, "Namosa Bubundu look at you with trust in her eyes, but doesn't seem to know why you're speaking with her.")
    end
  end
end
...
function event_trade(e)
  ...
  if rep > 2 then
    ...
    if item_lib.check_turn_in(e.trade, {item1 = 52175}) then
      ...
      e.other:SetBucket('god.bic.riwwi', '3')
